...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if ($user) {
        ...
        $reset_link = "http://localhost/final/login/user_reset_password.php?token=$token";
        ...
        $_SESSION['error'] = "No User account found with that email address.";
    }
}
...
<a href="user_login.php" class="back-button">Back</a>
