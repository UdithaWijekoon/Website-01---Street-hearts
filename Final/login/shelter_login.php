...
<head>
    ...
    <style>
        /* Similar styling as admin login page */
        body {
...
<div class="login-container">
    ...
    <div class="form-section">
        <h2><i class="fas fa-sign-in-alt"></i> Shelter Login</h2>
    ...
    <?php endif; ?>
        ...
        <form action="shelter_login_handler.php" method="POST">
            ...
            <div class="text-end mb-3">
                <a href="shelter_forgot_password.php" class="text-primary">Forgot your password?</a>
            </div>
...
<script>
    window.onload = function() {
        ...
        <?php elseif ($errorMessage == 'invalid'): ?>
            showPopupAlert('Invalid email or password.', 'error');
        <?php endif; ?>
    };
